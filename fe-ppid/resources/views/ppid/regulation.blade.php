...
@section('content')
    ...
    <section class="relative fs-gradient overflow-hidden">
        ...
        <div class="relative z-10 max-w-screen-2xl mx-auto px-6 lg:px-8 py-16 lg:py-20 text-center">
            ...
            <h1 class="text-4xl lg:text-5xl font-bold text-white leading-tight">{!! $judulDua(__($data['title'] ?? 'Daftar Regulasi'), 1, 'fs-title-accent-soft') !!}</h1>
    ...
    <section class="py-16 lg:py-20 bg-[#FAF6EC] dark:bg-[#082217]">
        <div class="max-w-screen-2xl mx-auto px-6 lg:px-8">
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @foreach ($data['regulations'] as $index => $regulation)
                                <tr class="hover:bg-[#FAF6EC] dark:bg-[#082217] transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="px-3 py-1 inline-flex text-xs font-semibold rounded-full
                                            {{ $regulation['type'] == 'Internal PPID' ? 'bg-emerald-50 text-[#10462F]' :
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <a href="{{ $regulation['link'] }}" target="_blank"
                                           class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold rounded-lg text-white bg-[#10462F] hover:bg-[#0B3524] transition-colors duration-200">
            ...
            <div class="mt-8 p-6 sm:p-8 bg-emerald-50 rounded-2xl border border-emerald-100 flex items-start gap-4">
                <span class="w-10 h-10 flex-shrink-0 bg-emerald-100 text-[#10462F] rounded-xl flex items-center justify-center">
