                            ...
                            <div class="flex flex-col sm:flex-row">
                                ...
                                <div class="flex-1 p-6 sm:p-7">
                                    ...
                                    <div class="flex flex-wrap items-center justify-between gap-3">
                                        ...
                                        {{-- Tombol "Lihat" dilepas (UAT poin 16). Kartunya sendiri
                                             sudah menjadi tautan — judulnya dilebarkan lewat ::after
                                             ke seluruh kartu — jadi tombol itu hanya mengulang jalan
                                             yang sama. Keterangan "Belum tersedia" tetap dipasang
                                             untuk baris yang memang belum punya dokumen. --}}
                                        @if (empty($regulation['url']) && empty($regulation['link']))
