...
@section('title', __('Berita & Publikasi') . ' | ' . __('PPID FSTJ'))
@section('content')
    ...
    <section class="relative fs-gradient overflow-hidden">
        ...
        <div class="relative z-10 max-w-screen-2xl mx-auto px-6 lg:px-8 py-16 lg:py-20 text-center">
            ...
            <h1 class="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight">{!! $judulDua(__('Berita & Publikasi'), 2, 'fs-title-accent-soft') !!}</h1>
