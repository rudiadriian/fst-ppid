    ...
    <section class="py-16 lg:py-20 bg-[#FAF6EC] dark:bg-[#082217]">
        <div class="max-w-screen-2xl mx-auto px-6 lg:px-8">
            ...
            @forelse ($data['items'] as $item)
                <article class="mb-6 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm sm:p-8 dark:border-white/10 dark:bg-[#0B2A1D]">
                    <div class="flex flex-wrap items-start justify-between gap-4">
                        <div class="flex items-start gap-4">
                            <span class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-emerald-50 text-sm font-bold text-[#10462F] dark:bg-white/5 dark:text-[#3E9C6C]">{{ $item['no'] }}</span>
                            <div>
            ...
            <div class="mt-8 flex items-start gap-4 rounded-2xl border border-emerald-100 bg-emerald-50 p-6 sm:p-8 dark:border-emerald-500/20 dark:bg-emerald-500/10">
                ...
                <div>
                    ...
                    <p class="text-base font-normal leading-relaxed text-gray-600 dark:text-gray-300">
                        ...
                        <a href="{{ route('ppid.objection') }}" class="font-semibold text-[#10462F] hover:text-[#0B3524] dark:text-[#3E9C6C]">{{ __('Pengajuan Keberatan') }}</a>.
                    </p>
                </div>
            </div>
