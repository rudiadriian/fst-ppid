{{-- Tombol aksi satu entri Daftar Informasi Dikecualikan.
     ...
     Dua tombol dengan urusan berbeda:
       - "Lihat / Unduh" membuka dialog dua pilihan atas informasinya sendiri.
         Keduanya memakai alamat yang diisikan petugas di panel, dan tiap
         pilihan hanya muncul bila alamatnya memang diisi — pada daftar ini
         penerbitan adalah keputusan petugas yang langsung terbaca publik.
