...
class ModulSistemSeeder extends Seeder
{
     ...
     */
    private const MODUL = [
        'dashboard' => ['Dashboard', 'heroicons-outline:home', '/dashboard', 1],
        'informasi-publik' => ['Informasi Publik', 'heroicons-outline:document-text', '/informasi-publik', 2],
        'kategori-informasi' => ['Kategori Informasi', 'heroicons-outline:tag', '/kategori-informasi', 3],
        'informasi-dikecualikan' => ['Informasi Dikecualikan', 'heroicons-outline:lock-closed', '/informasi-dikecualikan', 4],
        'permohonan' => ['Permohonan Informasi', 'heroicons-outline:inbox', '/permohonan', 5],
        'keberatan' => ['Keberatan Informasi', 'heroicons-outline:exclamation', '/keberatan', 6],
        'laporan-layanan' => ['Laporan Layanan', 'heroicons-outline:chart-bar', '/laporan-layanan', 7],
        'berita' => ['Berita', 'heroicons-outline:newspaper', '/berita', 8],
        'galeri' => ['Galeri', 'heroicons-outline:photograph', '/galeri', 9],
        'faq' => ['FAQ', 'heroicons-outline:question-mark-circle', '/faq', 10],
        'banner-slider' => ['Banner Slider', 'heroicons-outline:presentation-chart-line', '/banner-slider', 11],
        'struktur-organisasi' => ['Struktur Organisasi', 'heroicons-outline:users', '/struktur-organisasi', 12],
        'halaman-statis' => ['Halaman Statis', 'heroicons-outline:template', '/halaman-statis', 13],
        'regulasi' => ['Regulasi & Dasar Hukum', 'heroicons-outline:scale', '/regulasi', 14],
        'tautan-terkait' => ['Tautan Terkait', 'heroicons-outline:link', '/tautan-terkait', 15],
        'menu-navigasi' => ['Menu Navigasi', 'heroicons-outline:menu', '/menu-navigasi', 16],
        'pengguna' => ['Pengguna & Role', 'heroicons-outline:user-group', '/pengguna', 17],
        'pengaturan-situs' => ['Pengaturan Situs', 'heroicons-outline:cog', '/pengaturan-situs', 18],
        'audit-log' => ['Audit Log', 'heroicons-outline:clipboard-list', '/audit-log', 19],
    ];
